...
// 定義 reactive 變量
const 自動化指令 = ref([
  { text: '濕度 > 80%時，自動開啟 Tapo 插座來控制電風扇，保持家中環境適宜', color: '#e2dede' },  // 初始為白色
  { text: '燈泡和燈條會在模式期間隨機亮起模擬家中有人，以嚇阻不速之客並增強家庭安全感', color: '#e2dede' },
  { text: '關閉臥室插頭', color: '#e2dede' },  
  { text: '關燈泡', color: '#e2dede' },
  { text: '根據當日的天氣，提醒用戶記得帶雨傘、注意防曬等消息', color: '#e2dede' },
  { text: '根據用戶手機電量，提醒用戶記得帶行動電源', color: '#e2dede' }
]);
