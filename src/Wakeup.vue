...
// 定義 reactive 變量
const 自動化指令 = ref([
  { text: '設定智慧窗簾於起床前15分鐘，用逐漸變亮的環境喚醒身體，讓身體慢慢適應光線而醒來', color: '#e2dede' },  
  { text: '避免早晨的溫較低會容易賴床或感冒，會在早晨設定智慧空調或電風扇，根據當日的氣溫自動調整室內溫度到舒適的範圍', color: '#e2dede' },  
  { text: '開燈泡', color: '#e2dede' },
  { text: '開燈泡', color: '#e2dede' }
]);
