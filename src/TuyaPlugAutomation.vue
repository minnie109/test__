...
/* 串畫面區 */
  ...
  const emit = defineEmits(['GoTuyaPlugAutomationList']);
...
<template>
    <div class="燈泡自動化container">
        <div class="top標">
            <div class="topIcon">
                <img class="上一頁" src="/icon/回上一頁.svg" @click="GoTuyaPlugAutomationList">
                <div class="text">Tuya</div>
                <img class="燈泡icon" src="/icon/插座.svg">
            </div>
            <div @click="GoTuyaPlugAutomationList" class="text">儲存</div>
        </div>
        <div class="條件區">
            <div class="條件塊" >
                <div class="左">
        ...
        <div class="動作區">
            ...
            <div class="動作展開塊" >
                <div class="編輯塊">
                    <div class="編輯標題">
                        <img  class="裝置圖標" src="/icon/插座.svg">
                    </div>
                    <div class="動作裝置">Tuya插座</div>
