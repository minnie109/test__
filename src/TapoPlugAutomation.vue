...
/* 串畫面區 */
  ...
  const emit = defineEmits(['GoTapoPlugAutomationList']);
...
<template>
    <div class="燈泡自動化container">
        <div class="top標">
            <div class="topIcon">
                <img class="上一頁" src="/icon/回上一頁.svg" @click="GoTapoPlugAutomationList">
                <div class="text">Tapo</div>
                <img class="燈泡icon" src="/icon/插座.svg">
            </div>
            <div @click="GoTapoPlugAutomationList" class="text">儲存</div>
        </div>
        <div class="條件區">
            <div class="條件塊" >
                <div class="左">
